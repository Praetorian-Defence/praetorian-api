# Generated by Django 3.0.14 on 2021-05-07 10:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_data', apps.core.fields.aes_json_field.AesJSONField(default='{}', verbose_name='user_additional_data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', django_enum_choices.fields.EnumChoiceField(choice_builder=django_enum_choices.choice_builders.value_value, choices=[('deploy', 'deploy'), ('maintaining', 'maintaining')], default=apps.core.models.service.Service.ServiceType['DEPLOY'], enum_class=apps.core.models.service.Service.ServiceType, max_length=11, verbose_name='service_type')),
                ('variables', apps.core.fields.aes_json_field.AesJSONField(default='{}', verbose_name='service_variables')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('services', models.ManyToManyField(related_name='remotes', to='core.Service', verbose_name='remote_services')),
            ],
            options={
                'verbose_name': 'remote',

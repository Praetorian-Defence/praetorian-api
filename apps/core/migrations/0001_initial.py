# Generated by Django 3.0.14 on 2021-05-09 11:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_data', apps.core.fields.aes_json_field.AesJSONField(default=dict, verbose_name='user_additional_data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_body', apps.core.fields.aes_json_field.AesJSONField(default=dict, null=True, verbose_name='log_entry_request_body')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('name', models.CharField(max_length=50, unique=True, verbose_name='project_name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('name', models.CharField(max_length=100, verbose_name='remote_name')),
                ...
                ('user', apps.core.fields.aes_text_field.AesTextField(verbose_name='remote_user')),
                ('password', apps.core.fields.aes_text_field.AesTextField(verbose_name='remote_password')),
                ('variables', apps.core.fields.aes_json_field.AesJSONField(default=dict, verbose_name='remote_variables')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='remotes', to='core.Project', verbose_name='remote_project')),
            ],
            options={
                'verbose_name': 'remote',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variables', apps.core.fields.aes_json_field.AesJSONField(default=dict, verbose_name='service_variables')),
                ('remote', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='services', to='core.Remote', verbose_name='service_remote')),
            ],
            options={

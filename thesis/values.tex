...
\newcommand{\FIITevidenceNumber}[0] {FIIT-183739-79829}
\newcommand{\FIITdate}[0] {May 2021}
\newcommand{\FIITdateSK}[0] {Máj 2021}
...
\newcommand{\FIITinstitute}[0] {Institute of Informatics and Software Engineering}
...
\newcommand{\FIITsignDate}[0] {17.5.2021}
